...
public class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler({UsernameNotFoundException.class, BadAttributeValueExpException.class, BadCredentialsException.class  })
    ...
    /**
     * Fallback handles and unhandled exceptions.
     * @param ex
     * @return
     */
