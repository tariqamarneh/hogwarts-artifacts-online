...
class WizardControllerTest {
    ...
    void testAddWizardSuccess() throws Exception {
        // Given
        WizardDto wizardDto = new WizardDto(null, "Tariq", null);
        String json = this.objectMapper.writeValueAsString(wizardDto);

        Wizard savedWizard = new Wizard();
        savedWizard.setId(4);
        savedWizard.setName("Tariq");
    ...
    void testUpdateWizardSuccess() throws Exception {
        // Given
        WizardDto wizardDto = new WizardDto(1, "Tariq", null);
        String json = this.objectMapper.writeValueAsString(wizardDto);

        Wizard updatedWizard = new Wizard();
        updatedWizard.setId(1);
        updatedWizard.setName("Tariq");
    ...
    @Test
    void testUpdateWizardErrorWithNoneExistingId() throws Exception {
        // Given
        WizardDto wizardDto = new WizardDto(1, "Tariq", null);
        String json = this.objectMapper.writeValueAsString(wizardDto);
    ...
    @Test
    void testDeleteWizardErrorWithNoneExistingId() throws Exception {
        // Given
    ...
    @Test
    void testAssignArtifactErrorWithNoneExistentWizardId() throws Exception {
        // Given
    ...
    @Test
    void testAssignArtifactErrorWithNoneExistentArtifactId() throws Exception {
        // Given
